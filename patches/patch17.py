...
[data-theme="blossom"] .glyph { color: var(--t-glyph); filter: drop-shadow(0 0 42px rgba(252,231,243,.40)); opacity: .55; }
[data-theme="blossom"] .glyph::before {
  background:
...
[data-theme="blossom"] .glyph::after {
...
(function(){
  ...
  function setBtnColor(){
    var t = saved;
    var colors = {
      dark: '#3D87FF', light: '#3D87FF', vibrant: '#ec4899', blossom: '#f9a8d4'
    };
...
print("PATCHED stream.html: 4 themes added (Dark, Light, Vibrant, Blossom) + theme switcher")
